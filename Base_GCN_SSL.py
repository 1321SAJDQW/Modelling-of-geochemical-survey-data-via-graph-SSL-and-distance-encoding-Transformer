...
#!/usr/bin/env python
# -*- coding: utf-8 -*-
# This code is designed for geochemical anomaly recognition based solely on a graph self-supervised learning model.
...
optimizer_classifier = torch.optim.Adam(Classifier.parameters(), lr=0.00005, weight_decay=0.0005)
...
data.to_csv('Prediction_Nantianshan_Base.csv', index=False)
